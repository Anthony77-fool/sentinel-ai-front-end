...
import { OrganizationRightside } from './signup3-sections/OrganizationRightside';

export default function SignUpPage3_Organization() {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Provide your organization's details to complete the setup"
        />
      </Helmet>
      ...
      <div className="flex flex-col lg:flex-row min-h-screen lg:h-screen w-full bg-white overflow-x-hidden">
        ...
        <div className="relative w-full lg:w-[55%] h-[30vh] lg:h-full flex flex-col justify-end p-8 lg:p-16 text-white">
          ...
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('/imgs/SignUpPage-img-hero4.webp')`,
            }}
          />
